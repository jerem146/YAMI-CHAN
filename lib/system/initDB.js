...
function initDB(m, client) {
  ...
  settings.nameid ??= "🍓꒷︶꒷꒥꒷˚videos para ti˚꒷︶꒷꒥꒷🌺"
  settings.type ??= 'Owner'
  settings.link ??= 'Adremos un sorteo con este canal los q van anotarse al privado plis!'
  settings.banner ??= 'https://cdn.yuki-wabot.my.id/files/tCVD.jpeg'
  settings.icon ??= 'https://i.postimg.cc/qBGN8dDv/file-000000003d5871f59a50c6c72f709fe0.png'
  settings.currency ??= 'soles'
  settings.namebot ??= '🌸💖YAMI💖🌸'
  settings.botname ??= '💕Yami-chan💕'  
  settings.owner ??= ''
